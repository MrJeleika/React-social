    ...
    <Form
      ...
      render={({ handleSubmit, form, submitting, pristine, values }) => (
        <form className="loginForm__body" onSubmit={handleSubmit}>
            ...
            {({ input, checkbox, meta }) => (
              <div className="form__item">
                <input
                  ...
                  className={
                    meta.error
                      ? 'checkbox__input checkbox__input_err'
                      : 'checkbox__input'
                  }
                  component={'checkbox'}
                  id="loginCheckbox"
                ...
                <label
                  className={
                    meta.error
                      ? 'checkbox__label checkbox__label_err'
                      : 'checkbox__label'
                  }
                  for="loginCheckbox"
                >
          ...
          <div
            className={
              props.social.isLoginError ? 'form__item' : 'form__item hidden'
            }
          >
            <div className="form__error">Invalid Email or password</div>
          </div>
